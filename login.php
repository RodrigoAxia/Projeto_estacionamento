...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (password_verify($senha, $linha["senha"])) {
        ...
        echo 'Usuario ou senha são invalidos';
    }
}
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        ...
        <form class="form" method="post">
            ...
            <div class="field">
                ...
                <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="usuario">
            </div>
            <div class="field">
                <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
                </svg>
                <input placeholder="Password" class="input-field" type="password" name="senha">
            </div>
            <div class="btn">
                <button type="submit" class="button1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Logar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
            </div>
